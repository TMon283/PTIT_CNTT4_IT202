...
-- 2.Tạo một view có tên view_users_firstname để hiển thị danh sách các người dùng có họ “Nguyễn”
...
INSERT INTO users (username, full_name, gender, email, password, birthdate, hometown) VALUES
('tdat', 'Nguyễn Thành Đạt', 'Nam', 'datnguyen@gmail.com', '123', '2006-01-03', 'Hà Nội');
...
DELETE FROM users WHERE username = 'tdat';
